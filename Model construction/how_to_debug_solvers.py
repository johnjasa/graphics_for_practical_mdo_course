...
# 4. For fixed-point iteration methods, use Aitken relaxation\\
# 5. For Newton methods, follow the detailed debugging doc page\\
# 6. Reorganize your model to minimize subsystem size within a solver\\
# 7. Try using a nested solver hierarchy or a different solver setup\\
# 8. Remove (or "fix") some states within the solver loop\\
# }"""
